...
background = pygame.image.load('e:/Game using Python/dragon_night.jpg')
background_rect = background.get_rect()
background_rect.topleft = (0,0)

#setup the actors
coin = pygame.image.load('e:/Game using Python/coin.png')
coin_rect = coin.get_rect()
coin_rect.left = BUFFER_DISTANCE
coin_rect.top = random.randint(64, WINDOW_HEIGHT-64)


dragon = pygame.image.load('e:/Game using Python/dragon.png')
dragon_rect = dragon.get_rect()
dragon_rect.centery = WINDOW_HEIGHT//2
dragon_rect.right = WINDOW_WIDTH -10

#setup the sound and music
pickup = pygame.mixer.Sound('e:/Game using Python/pickup.wav')
loss = pygame.mixer.Sound('e:/Game using Python/loss.wav')

pygame.mixer.music.load('e:/Game using Python/background_music.mp3')
...
#font
game_font = pygame.font.Font('e:/Game using Python/AttackGraffiti.ttf', 32) #fontname, fontsize
